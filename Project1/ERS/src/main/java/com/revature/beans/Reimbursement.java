...
public class Reimbursement {
	public enum RequestType {
		MEDICAL(1), TRAVEL(2), RELOCATION(3), COMMUTE(4), TRAINING(5), SUPPLIES(6);
	...
	public Reimbursement(int id, double amount, String description, boolean has_receipt, Date submitted_date,
